"""
Django settings for RaisingMinds project.
...
SECRET_KEY = 'django-insecure-xut6*mj33d#$gsoya1!qwcw^pj-ah&n5esbx5ov6ylrz2jare^'
...
ROOT_URLCONF = 'RaisingMinds.urls'
...
WSGI_APPLICATION = 'RaisingMinds.wsgi.application'
